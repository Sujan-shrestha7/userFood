    ...
    <div>
      ...
      <div className="flex flex-wrap items-center justify-center">
        <div className="mb-[60px]  ml-[110px]">
          ...
          <div className="w-[620px] h-[120px] flex flex-wrap gap-[20px] items-center justify-center mt-[30px] bg-[#fff] rounded-[10px]">
      ...
      <div className="w-full h-[600px] bg-[#F9F9F9] relative">
        ...
        <div className="pt-[200px] pl-[140px] flex flex-wrap gap-[20px]">
            <div className="h-[250px] w-[280px] bg-[#000000] rounded-[30px]">
